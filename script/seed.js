...
async function seed() {
  ...
  const properties = await Promise.all([
    Property.create({
      ...
      sqft: 2200,
      imageURL:
        'https://media.istockphoto.com/photos/modern-custom-suburban-home-exterior-picture-id1255835530?b=1&k=20&m=1255835530&s=170667a&w=0&h=vWteBzGCikOwcc8iznEOTM_Sdk8URYryKlBmaxMJdcs=',
      type: 'Single-Family',
      userId: 1,
    }),
    Property.create({
